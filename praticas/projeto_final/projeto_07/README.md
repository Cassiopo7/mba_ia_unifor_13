# Projeto 07 — Análise de Dados de RH — People Analytics
...
O departamento de RH de uma empresa de tecnologia com 1.200 funcionários precisa entender os fatores que influenciam a rotatividade (turnover). Nos últimos 2 anos, a taxa de turnover subiu de 12% para 19%, e o custo estimado de cada desligamento é de R$ 45.000. A VP de Pessoas precisa de evidências para fundamentar uma nova política de retenção.

## Dataset

- **Arquivo:** `data/projeto_07_people_analytics.csv`
...
Análise bivariada intensiva, countplot com hue, catplot, cálculo de taxas e proporções, análise de coorte simplificada, stacked bars normalizados e correlação ponto-bisserial (variável binária vs. contínua), conforme conteúdo dos três módulos do curso.
